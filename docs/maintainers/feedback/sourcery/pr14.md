...
**Type**: ⚠️ DEPRECATED: This command has been consolidated into `/pr --phase [N]`
...
|---------|----------|--------|--------|-------|
| #1 | 🟡 MEDIUM | 🟢 LOW | 🟢 LOW | Strengthen test assertions for ordering - use IDs instead of relying on insertion order |
| #2 | 🟢 LOW | 🟢 LOW | 🟢 LOW | Clarify `/pr` vs `@pr` notation in deprecation note - documentation improvement |

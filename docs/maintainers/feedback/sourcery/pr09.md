...
| --------- | --------- | --------- | --------- | --------------------------------------------------------- |
| #1        | 🟢 LOW    | 🟡 MEDIUM | 🟢 LOW    | Test improvement: Assert exact error message              |
| #2        | 🟢 LOW    | 🟢 LOW    | 🟢 LOW    | Test cleanup: Remove redundant monkeypatch restore        |
| Overall-1 | 🟡 MEDIUM | 🟡 MEDIUM | 🟡 MEDIUM | Code duplication: Extract status validation helper        |
| Overall-2 | 🟢 LOW    | 🟡 MEDIUM | 🟢 LOW    | Test improvement: Assert full error messages (same as #1) |

...
| Overall #2 | 🟡 MEDIUM | 🟡 MEDIUM | 🟡 MEDIUM | ✅ Fixed | Scope API mocking more narrowly (Fixed in PR #31, pr29-batch-medium-medium-01) |
| Overall #3 | 🟡 MEDIUM | 🟢 LOW | 🟠 HIGH | ✅ Fixed | Improve CLI script loading mechanism (Fixed in PR #31, pr29-batch-medium-medium-01) |

"""
Project CLI Tool - Click Group Definition

This module exposes the Click CLI group for the project management tool.
It can be imported directly by tests and other modules, avoiding the need
to execute the proj script file.
"""
